...
export function buildSeed(): AppData {
  ...
  const programaciones: Programacion[] = [
    ...
    { id: "p5", subjectId: "m6", curso: c.label, estado: "Finalizada", contexto: CONTEXTO, criterios: ["tp.1.1", "tp.1.2", "tp.2.1", "tp.2.2", "tp.3.1", "tp.3.2", "tp.3.3", "tp.4.1", "tp.4.2", "tp.5.1", "tp.5.2"], ponderaciones: { "tp.1.1": 8, "tp.1.2": 7, "tp.2.1": 10, "tp.2.2": 10, "tp.3.1": 10, "tp.3.2": 12, "tp.3.3": 8, "tp.4.1": 10, "tp.4.2": 8, "tp.5.1": 6, "tp.5.2": 6 }, ccalificacion: "El proyecto final de podcast tiene un peso del 40%.", actualizada: hoy },
  ...
  const units: Unit[] = [
    ...
    { id: "u11", programacionId: "p5", titulo: "Guion y producción sonora", inicio: toISO(new Date(c.y + 1, 0, 14)), fin: toISO(new Date(c.y + 1, 1, 20)), sesiones: 12, saIds: ["sa16"], criterios: ["tp.2.1", "tp.2.2", "tp.3.1", "tp.3.2"] },
    { id: "u12", programacionId: "p5", titulo: "Proyecto final de podcast", inicio: toISO(new Date(c.y + 1, 2, 24)), fin: toISO(new Date(c.y + 1, 4, 28)), sesiones: 15, saIds: ["sa17"], criterios: ["tp.3.3", "tp.4.1", "tp.4.2", "tp.5.2"] },
