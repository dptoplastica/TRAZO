...
export function buildSeed(): AppData {
  ...
  const programaciones: Programacion[] = [
    ...
    },
    {
      ...
      contexto: CONTEXTO,
      criterios: ["dt1.1.1", "dt1.1.2", "dt1.2.1", "dt1.2.2", "dt1.2.3", "dt1.3.1", "dt1.3.2", "dt1.4.1", "dt1.4.2"],
      ponderaciones: { "dt1.1.1": 12, "dt1.1.2": 13, "dt1.2.1": 15, "dt1.2.2": 12, "dt1.2.3": 13, "dt1.3.1": 10, "dt1.3.2": 10, "dt1.4.1": 8, "dt1.4.2": 7 },
      ccalificacion: "Las láminas se califican con escalas de valoración publicadas al inicio del curso. La limpieza, precisión y justificación del procedimiento son criterios transversales. El proyecto final integra geometría, diédrico y normalización. Las prácticas CAD se evalúan con rúbrica específica.",
      actualizada: hoy,
    },
    {
  ...
  const sas: SA[] = [
    ...
    },
    {
      ...
      criterios: ["dt1.1.1", "dt1.1.2", "dt1.3.1", "dt1.3.2"],
      objetivos: ["Resolver problemas de tangencias y polígonos regulares", "Aplicar la geometría a la lectura del patrimonio", "Normalizar láminas con rigor técnico"],
      actividades: [
        { id: "sa7a1", titulo: "Construcciones fundamentales", desc: "Ángulos, paralelismos, perpendicularidades y triángulos.", fase: "Inicio", sesion: 2, criterioIds: ["dt1.1.1"] },
        { id: "sa7a2", titulo: "Tangencias y curvas técnicas", desc: "Enlaces, tangencias comunes, óvalos y ovoides.", fase: "Desarrollo", sesion: 5, criterioIds: ["dt1.1.2"] },
        { id: "sa7a3", titulo: "Salida de campo: patrimonio románico", desc: "Fotografía y medición de rosetas y portadas.", fase: "Desarrollo", sesion: 8, criterioIds: ["dt1.1.1", "dt1.1.2"] },
        { id: "sa7a4", titulo: "Reconstrucción geométrica", desc: "Lámina de reconstrucción de una roseta con justificación.", fase: "Desarrollo", sesion: 11, criterioIds: ["dt1.1.2", "dt1.3.1"] },
        { id: "sa7a5", titulo: "Normalización y entrega", desc: "Acotación, rotulación y presentación del dossier.", fase: "Cierre", sesion: 14, criterioIds: ["dt1.3.1", "dt1.3.2"] },
      ],
      instrumentos: ["i17", "i18", "i19"],
    },
    {
      ...
      criterios: ["dt1.2.1", "dt1.2.2", "dt1.3.1", "dt1.3.2"],
      objetivos: ["Representar piezas en sistema diédrico", "Obtener verdaderas magnitudes", "Normalizar planos con rigor"],
      actividades: [
        { id: "sa8a1", titulo: "Punto, recta y plano en el diedro", desc: "Fundamentos del sistema diédrico.", fase: "Inicio", sesion: 2, criterioIds: ["dt1.2.1"] },
        { id: "sa8a2", titulo: "Intersecciones y verdadera magnitud", desc: "Abatimientos y cambios de plano aplicados a piezas.", fase: "Desarrollo", sesion: 5, criterioIds: ["dt1.2.2"] },
        { id: "sa8a3", titulo: "Croquis acotado de pieza real", desc: "Medición y croquizado a mano alzada con acotación.", fase: "Desarrollo", sesion: 8, criterioIds: ["dt1.3.2"] },
        { id: "sa8a4", titulo: "Plano normalizado", desc: "Vistas, corte seccional y acotación completa.", fase: "Desarrollo", sesion: 10, criterioIds: ["dt1.3.1"] },
        { id: "sa8a5", titulo: "Defensa del plano", desc: "Presentación y justificación de decisiones.", fase: "Cierre", sesion: 12, criterioIds: ["dt1.3.1", "dt1.3.2"] },
      ],
    ...
    },
    {
      ...
      criterios: ["dt1.2.3", "dt1.4.1", "dt1.4.2"],
      objetivos: ["Modelar en CAD paramétrico", "Integrar representación analógica y digital", "Comunicar proyectos técnicos"],
      actividades: [
        { id: "sa9a1", titulo: "Perspectiva axonométrica", desc: "Isométrica y dimétrica aplicadas al mobiliario.", fase: "Inicio", sesion: 2, criterioIds: ["dt1.2.3"] },
        { id: "sa9a2", titulo: "Introducción al CAD paramétrico", desc: "Croquizado, restricciones y parámetros en FreeCAD.", fase: "Desarrollo", sesion: 5, criterioIds: ["dt1.4.1"] },
        { id: "sa9a3", titulo: "Modelado del proyecto", desc: "Diseño paramétrico de la pieza de mobiliario.", fase: "Desarrollo", sesion: 9, criterioIds: ["dt1.4.1"] },
        { id: "sa9a4", titulo: "Documentación técnica", desc: "Plano normalizado A2 con vistas, cortes y acotación.", fase: "Desarrollo", sesion: 12, criterioIds: ["dt1.4.2"] },
        { id: "sa9a5", titulo: "Maqueta y defensa", desc: "Maqueta 1:10 y presentación del proyecto.", fase: "Cierre", sesion: 14, criterioIds: ["dt1.4.2"] },
      ],
  ...
  const units: Unit[] = [
    ...
    { id: "u7", programacionId: "p4", titulo: "Geometría plana y patrimonio", inicio: D(10), fin: D(55), sesiones: 14, saIds: ["sa7"], criterios: ["dt1.1.1", "dt1.1.2", "dt1.3.1", "dt1.3.2"] },
    { id: "u8", programacionId: "p4", titulo: "Sistema diédrico y normalización", inicio: toISO(new Date(c.y + 1, 0, 10)), fin: toISO(new Date(c.y + 1, 1, 28)), sesiones: 12, saIds: ["sa8"], criterios: ["dt1.2.1", "dt1.2.2", "dt1.3.1", "dt1.3.2"] },
    { id: "u9", programacionId: "p4", titulo: "Diseño digital y proyecto CAD", inicio: toISO(new Date(c.y + 1, 2, 25)), fin: toISO(new Date(c.y + 1, 4, 30)), sesiones: 14, saIds: ["sa9"], criterios: ["dt1.2.3", "dt1.4.1", "dt1.4.2"] },
  ...
  const instruments: Instrument[] = [
    ...
    /* Dibujo Técnico I */
    { id: "i17", subjectId: "m5", nombre: "Escala de valoración · láminas de geometría", tipo: "escala", peso: 25, criterioIds: ["dt1.1.1", "dt1.1.2"], fecha: D(30) },
    { id: "i18", subjectId: "m5", nombre: "Rúbrica · reconstrucción geométrica del patrimonio", tipo: "rubrica", peso: 30, criterioIds: ["dt1.1.2", "dt1.3.1"], fecha: D(50), rubrica: NIVELES_RUBRICA },
    { id: "i19", subjectId: "m5", nombre: "Prueba escrita · geometría plana y proporcionalidad", tipo: "escrita", peso: 15, criterioIds: ["dt1.1.1", "dt1.1.2"], fecha: D(55) },
    { id: "i20", subjectId: "m5", nombre: "Prueba práctica · sistema diédrico", tipo: "practica", peso: 35, criterioIds: ["dt1.2.1", "dt1.2.2"], fecha: D(95) },
    { id: "i21", subjectId: "m5", nombre: "Rúbrica · plano normalizado", tipo: "rubrica", peso: 25, criterioIds: ["dt1.3.1", "dt1.3.2"], fecha: D(100), rubrica: NIVELES_RUBRICA },
    { id: "i22", subjectId: "m5", nombre: "Proyecto CAD · mobiliario paramétrico", tipo: "digital", peso: 30, criterioIds: ["dt1.4.1", "dt1.4.2"], fecha: D(150) },
    { id: "i23", subjectId: "m5", nombre: "Rúbrica · documentación técnica del proyecto", tipo: "rubrica", peso: 20, criterioIds: ["dt1.4.2"], fecha: D(155), rubrica: NIVELES_RUBRICA },
    /* Taller de Podcast */
