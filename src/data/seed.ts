...
export function buildSeed(): AppData {
  ...
  const instruments: Instrument[] = [
    ...
    // Dibujo Técnico I - Geometría que construye (sa24)
    { id: "i49", subjectId: "m5", nombre: "Dossier de 8 láminas de geometría plana", tipo: "portfolio", peso: 40, criterioIds: ["dt1.2.1", "dt1.2.2", "dt1.2.3"], fecha: D(65) },
  ...
  return { version: 17, role: "profesor", teacherId: "t1", cursoLabel: c.label, teachers, groups, students, subjects, programaciones, sas, units, instruments, grades, attendance, observations, measures, recoveries };
}
