    ...
    <div className="min-h-screen flex items-center justify-center bg-paper bg-blueprint p-4">
      <div className="card p-8 w-full max-w-md shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {error && (
            <div className="flex items-center gap-2 rounded-lg bg-verml px-3 py-2 text-[12.5px] font-semibold text-verm">
              <Ic n="alert" s={14} />
              {error}
            </div>
          )}
        ...
        <p className="mono mt-6 text-center text-[9.5px] uppercase tracking-widest text-ink3">
